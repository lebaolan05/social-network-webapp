...
<main class="page-wrap">
    ...
    <div class="card">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem">
            <div>
                <div style="font-family:var(--font-head);font-size:.72rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:var(--muted);margin-bottom:.4rem">Le Bao Lan</div>
                <div style="font-family:var(--font-head);font-size:1.15rem;font-weight:800">Your Full Name</div>
            </div>
            <div>
                <div style="font-family:var(--font-head);font-size:.72rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:var(--muted);margin-bottom:.4rem">1695462</div>
